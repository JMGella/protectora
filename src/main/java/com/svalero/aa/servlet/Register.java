...
public class Register extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (isRegister == false) {
            try {
                Database.connect();
                int affectedRows = Database.jdbi.withExtension(UserDao.class, dao -> dao.updateUser(name, username, password, id));
                response.getWriter().println("<div class='alert alert-success' role='alert'>" + "Usuario actualizado correctamente." + "</div><br><a class='btn btn-primary' href='/ActividadAprendizaje'>Volver al inicio</a>");
